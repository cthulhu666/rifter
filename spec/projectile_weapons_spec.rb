...
RSpec.describe "Projectile weapons" do
  ...
  context "Sleipnir" do
    ...
    describe 'optimal + falloff' do
      context 'Tracking Enhancer' do
        ...
        it { expect(fit.turrets.first.falloff).to be_within(0.1).of(14512.5) }
      end
      ...
      context 'Tracking Computer' do
        ...
        it { expect(fit.turrets.first.falloff).to be_within(0.1).of(15721.9) }
      end
    end
  end
  ...
  context "Tornado" do
    ...
    describe '#turrets_volley' do
      ...
      it { expect(fit.turrets.first.falloff).to be_within(0.1).of(32250) }
